...
<body>
  ...
  <div class="image-container" onclick="document.getElementById('product-image2').click()">
    ...
    <input type="file" id="product-image2" name="Image2" accept="image/*" onchange="previewImage(event, 'preview2')" class="file-input">
  </div>
  ...
  <div class="image-container" onclick="document.getElementById('product-image3').click()">
    ...
    <input type="file" id="product-image3" name="Image3" accept="image/*" onchange="previewImage(event, 'preview3')" class="file-input">
  </div>
</div>
